...
public class ElasticSearchOperations {
     ...
     * @param model the ArrayList of CommentModels to clear and then fill with the new data
     * @param activity a MainListViewActivity
     * 
     * @author zjullion; adapted by dvyee
     */
    public static void searchForCommentModels(final String searchTerm, final ArrayList<CommentModel> model, 
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                //String query =  "{\"query\": {\"query_string\": {\"default_field\": \"content\",\"query\": \"*" + searchTerm + "*\"}}}";
                ...
                final ElasticSearchSearchResponse<CommentModel> returnedData = GSON.fromJson(responseJson, elasticSearchSearchResponseType);
